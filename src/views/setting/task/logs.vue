  ...
  <el-container>
		<el-main  style="padding:0 20px;">
			<Table :data="data" stripe>
				<el-table-column label="执行时间" prop="time" width="200" />
				...
				<el-table-column label="执行日志" prop="logs" width="100" fixed="right">
					<template #default>
						<el-button size="small" @click="logsVisible = true" type="text">日志</el-button>
					</template>
				</el-table-column>
			</Table>
		</el-main>
...
const data = [
  {time: '2021-07-07 00:00:00', state: '500', logs: ''},
  {time: '2021-07-06 00:00:00', state: '200', logs: ''},
  {time: '2021-07-05 00:00:00', state: '200', logs: ''},
  {time: '2021-07-04 00:00:00', state: '200', logs: ''},
  {time: '2021-07-03 00:00:00', state: '200', logs: ''},
  {time: '2021-07-02 00:00:00', state: '200', logs: ''},
  {time: '2021-07-01 00:00:00', state: '200', logs: ''}
]
const demoLog = `2021-07-07 12:35:00 [com.xxl.job.core.thread.JobThread#run]-[124]-[Thread-308]
