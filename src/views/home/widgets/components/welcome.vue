<template>
	<el-card shadow="hover" header="欢迎">
		<div class="welcome">
			...
			<div class="actions">
				<el-button type="primary" icon="el-icon-check" size="large" @click="window.open('https://lolicode.gitee.io/scui-doc/')">文档</el-button>
			</div>
		</div>
	</el-card>
</template>
...
const title = '欢迎'
const icon = 'el-icon-present'
const description = '项目特色以及文档链接'
</script>
