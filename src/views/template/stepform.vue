		...
		<el-card shadow="never" header="分步表单">
			...
			<el-row>
				<el-col :lg="{span: 8, offset: 8}">
					<el-form v-show="active === 0" ref="stepForm_0" :model="form" :rules="rules" label-position="top">
						...
						<el-form-item label="收款人姓名" prop="collectionName">
							<el-input v-model="form.collectionName" clearable />
						</el-form-item>
						<el-form-item label="转账金额" prop="amount">
							<el-input v-model="form.amount" />
						</el-form-item>
					</el-form>
					<el-form v-show="active === 1" ref="stepForm_1" :model="form" :rules="rules" label-position="top">
						...
						<el-form-item label="支付密码" prop="payPassword">
							<el-input v-model="form.payPassword" show-password placeholder="请输入" />
						</el-form-item>
					</el-form>
					<div v-show="active === 2">
					...
					<el-button v-show="active > 0 && active < 2" @click="pre" :disabled="submitLoading">上一步</el-button>
					<el-button v-show="active < 1" type="primary" @click="next">下一步</el-button>
					<el-button v-show="active === 1" type="primary" @click="submit" :loading="submitLoading">提交</el-button>
				</el-col>
			</el-row>
		</el-card>
	</el-main>
		...
		data() {
			return {
				...
				rules: {
					...
					collectionAccount: [{required: true,message: '请输入收款账户'}],
					collectionName: [{required: true,message: '请输入收款人姓名'}],
